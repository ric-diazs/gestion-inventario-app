...
fun ReporteProblemaFormScreen(
    ...
    val reporteRepo = ReporteProblemaRepository()

    val factory = AuthViewModelFactory(usuarioRepo, productoRepo, reporteRepo)
    val viewModel: AuthViewModel = viewModel(factory = factory)*/


    val reporteProblema by viewModel.reporteProblema.collectAsState()
        ...
        Scaffold(
            ...
            Column(
                ...
                Button(
                    ...
                    onClick = {navController.navigate(Routes.Reportar.ruta)},
                    modifier = Modifier
                        .padding(top = 8.dp)
                        .fillMaxWidth(0.6f)
                        .height(50.dp)
                ...
                if (reporteProblema.isEmpty()) {
                    Text(
                        text = "No hay reporte registrado",
                        ...
                        items(reporteProblema) { reporte ->
                            ...
                            Card(
                                modifier = Modifier
                                    ...
                                    .clickable{
                                        navController.navigate("DetalleProblema/${reporte.id}")
                                    },
